...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-700 via-primary-500 to-primary-800 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        {/* Logo/Branding */}
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <Logo variant="mark" className="h-16 w-16" inverted />
          </div>
          <h1 className="text-5xl font-bold text-white mb-2 tracking-tight">FormationIQ</h1>
          <p className="text-primary-200 text-lg">by PikeSquare</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <button
            ...
            className="w-full bg-accent-500 hover:bg-accent-600 text-white font-semibold py-4 px-6 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center justify-center gap-3"
          >
