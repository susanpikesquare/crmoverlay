      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <div className="text-center py-8">
          ...
          <p className="text-sm text-gray-600 mb-6 max-w-md mx-auto">
            Generate AI-powered insights from your Salesforce data and Gong call intelligence.
            This will analyze renewal risk, stakeholder sentiment, whitespace opportunities, and more.
          </p>
          <button
            onClick={onGenerate}
            disabled={isGenerating}
            className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-lg hover:from-indigo-700 hover:to-purple-700 transition shadow-md disabled:opacity-50 inline-flex items-center gap-2"
          >
            {isGenerating ? (
              <>
