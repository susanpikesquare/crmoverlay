...
import CustomerSuccessHome from './pages/CustomerSuccessHome';
      ...
      <Router>
        <Layout>
          <Routes>
            ...
            <Route path="/home/sales" element={<SalesHome />} />
            <Route path="/home/customer-success" element={<CustomerSuccessHome />} />
            <Route path="/home/leader" element={<LeaderHome />} />
